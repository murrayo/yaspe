...
(function() {
    ...
    function runToggle() {
        ...
        // IO axis autorange when becoming visible
        if (axisHasVisible['y2']) u['yaxis2.autorange'] = true;

        // Routing axes: hide/show + repack shifts + autorange when shown
        var shiftIdx = 0;
        ...
        busy = true;
        Plotly.relayout(gd, u).then(function() { busy = false; });
    }
